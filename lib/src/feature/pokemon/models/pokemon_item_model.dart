...
//
//     final pokemonItemModel = pokemonItemModelFromJson(jsonString);

import 'dart:convert';

PokemonItemModel pokemonItemModelFromJson(String str) => PokemonItemModel.fromJson(json.decode(str));

String pokemonItemModelToJson(PokemonItemModel data) => json.encode(data.toJson());
...
class PokemonItemModel {
    ...
    factory PokemonItemModel.fromJson(Map<String, dynamic> json) => PokemonItemModel(
